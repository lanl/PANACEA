...
TEST_CASE("Testing:primitive_factory create primitive group","[integration,panacea]") {
...
TEST_CASE("Testing:primitive_factory create primitive group shell","[integration,panacea]") {
  WHEN("Looking at Correlated Gaussian"){
    KernelSpecification specification(
        settings::KernelCorrelation::Correlated,
        settings::KernelCount::OneToOne,
