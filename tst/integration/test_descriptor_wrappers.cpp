...
TEST_CASE("Testing:descriptor_wrapper file io with write and read",
          "[integration,panacea]") {
  ...
  std::unique_ptr<panacea::io::FileIO> file_io =
      file_factory.create(settings::FileType::TXTDescriptors);
  std::fstream fs;
