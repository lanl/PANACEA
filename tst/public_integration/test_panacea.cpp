...
TEST_CASE("Testing:panacea self entropy","[integration,panacea]"){
  ...
  WHEN("Testing self entropy term with single point.") {
    ...
    double self_ent_val1 = self_ent->compute(dwrapper.get(), panacea_settings);
    ...
    double self_ent_val2 = self_ent->compute(dwrapper.get(), panacea_settings);
  ...
  WHEN("Testing self entropy term with two points.") {
    ...
    auto dwrapper = panacea_pi.wrap(&(array_data.data), rows, cols);
    std::unique_ptr<EntropyTerm> self_ent = panacea_pi.create(dwrapper.get(), panacea_settings);
    double self_ent_val_stacked = self_ent->compute(dwrapper.get(), panacea_settings);

    // move the data points apart and self entropy should increase
    dwrapper->operator()(0,0) = 0.0;
    dwrapper->operator()(1,0) = 2.0;

    double self_ent_val_spread = self_ent->compute(dwrapper.get(), panacea_settings);
...
TEST_CASE("Testing:panacea cross entropy shell + initialize","[integration,panacea]"){
  ...
  GIVEN("OneToOne mapping."){
    ...
    WHEN("Testing cross entropy term with single point.") {
      ...
      double cross_ent_val1 = cross_ent->compute(dwrapper.get(), panacea_settings);
      ...
      double cross_ent_val2 = cross_ent->compute(dwrapper.get(), panacea_settings);
    ...
    WHEN("Testing cross entropy term with two points.") {
      ...
      double cross_ent_val_stacked = cross_ent->compute(dwrapper.get(), panacea_settings);

      // move the data points apart and cross entropy should increase
      dwrapper->operator()(0,0) = 0.0;
      dwrapper->operator()(1,0) = 2.0;

      double cross_ent_val_spread = cross_ent->compute(dwrapper.get(), panacea_settings);
...
TEST_CASE("Testing:panacea self entropy read & write with fileio","[integration,panacea]"){
  ...
  PANACEA panacea_pi;
    ...
    double self_ent_val = self_ent->compute(dwrapper.get(), panacea_settings);
    ...
    double self_ent_val2 = self_ent2->compute(dwrapper.get(), panacea_settings);
...
TEST_CASE("Testing:panacea self entropy update","[integration,panacea]"){
  ...
  double self_ent_two_pts = self_ent->compute(dwrapper.get(), panacea_settings);
  ...
  double self_ent_single_pt = self_ent->compute(dwrapper.get(), panacea_settings);
  ...
  dwrapper = panacea_pi.wrap(&(data), rows, cols);
  self_ent->update(dwrapper.get());
  double self_ent_three_pts = self_ent->compute(dwrapper.get(), panacea_settings);
...
TEST_CASE("Testing:panacea cross entropy single mean","[integration,panacea]"){
  ...
  WHEN("Numerical cross entropy is compared with analytical"){
    ...
    const double val_left = cross_ent->compute(dwrapper.get(),0, panacea_settings);
    dwrapper->operator()(0,0) = 1.01;
    const double val_right = cross_ent->compute(dwrapper.get(),0, panacea_settings);
...
TEST_CASE("Testing:panacea cross entropy single mean update","[integration,panacea]"){
  ...
  double lower_cross_ent  = cross_ent->compute(dwrapper_sample.get(), 0, panacea_settings);
  double center_cross_ent = cross_ent->compute(dwrapper_sample.get(), 1, panacea_settings);
  double upper_cross_ent  = cross_ent->compute(dwrapper_sample.get(), 2, panacea_settings);
  ...
  lower_cross_ent  = cross_ent->compute(dwrapper_sample.get(), 0, panacea_settings);
  center_cross_ent = cross_ent->compute(dwrapper_sample.get(), 1, panacea_settings);
  upper_cross_ent  = cross_ent->compute(dwrapper_sample.get(), 2, panacea_settings);
...
TEST_CASE("Testing:panacea cross entropy single median update","[integration,panacea]"){
  ...
  std::unique_ptr<EntropyTerm> cross_ent = panacea_pi.create(dwrapper_init.get(), panacea_settings);
    ...
    std::cout << __FILE__ << ":" << __LINE__ << std::endl;
  cross_ent->compute(dwrapper_init.get(), panacea_settings);
  ...
  double cross_ent_val_single_pt_before_update = cross_ent->compute(dwrapper.get(), panacea_settings);
    std::cout << __FILE__ << ":" << __LINE__ << std::endl;
  cross_ent->update(dwrapper.get());
    std::cout << __FILE__ << ":" << __LINE__ << std::endl;
  ...
  // cross entropy should remain the same
    std::cout << __FILE__ << ":" << __LINE__ << std::endl;
  double cross_ent_val_single_pt_after_update = cross_ent->compute(dwrapper.get(), panacea_settings);
    std::cout << __FILE__ << ":" << __LINE__ << std::endl;
...
TEST_CASE("Testing:panacea cross entropy single median weighted","[integration,panacea]"){
  ...
  auto dwrapper = panacea_pi.wrap(&(desc_data), 1, cols);
  // The mean is currently at 10 and this new point is at 70 the cross entropy should be large
  double val1 = cross_ent1->compute(dwrapper.get(), panacea_settings1);
  double val2 = cross_ent2->compute(dwrapper.get(), panacea_settings2);
