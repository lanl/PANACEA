 ...
 */
template <class T> class DescriptorWrapper : public BaseDescriptorWrapper {
private:
...
template <class T>
inline double &DescriptorWrapper<T>::operator()(const int point_ind,
                                                const int dim_ind) {
...
template <class T> inline int DescriptorWrapper<T>::rows() const {
  return data_wrapper_.rows();
}

template <class T> inline int DescriptorWrapper<T>::cols() const {
...
template <class T>
inline int DescriptorWrapper<T>::getNumberDimensions() const {
  return data_wrapper_.getNumberDimensions();
}

template <class T> inline int DescriptorWrapper<T>::getNumberPoints() const {
...
template <class T>
inline const std::any DescriptorWrapper<T>::getPointerToRawData() const
    noexcept {
  return data_wrapper_.getPointerToRawData();
}

template <class T> inline void DescriptorWrapper<T>::print() const {
  data_wrapper_.print();
}
