...
namespace panacea {
  ...
  std::istream& operator>>(std::istream& is,  settings::DistributionType & dist_type) {
    std::string line;
    std::getline(is,line);
    if( line.find("Histogram", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized distribution type while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::EntropyOption & ent_opt) {
    ...
    if( line.find("Weight", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized entropy option while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::EntropyType & ent_type) {
    ...
    if( line.find("Self", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized entropy type while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::PANACEAAlgorithm & alg) {
    ...
    if( line.find("Strict", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized algorithm setting while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelPrimitive & kern_prim) {
    std::string line;
    std::getline(is,line);
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelCount & count) {
    ...
    if( line.find("OneToOne", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized kernel count setting while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelCorrelation & corr) {
    ...
    if( line.find("Correlated", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized kernel correlation while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelNormalization & norm) {
    std::string line;
    std::getline(is,line);
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelCenterCalculation & cent) {
    std::string line;
    std::getline(is,line);
    if( line.find("None", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized kernel center calculation type while ";
      error_msg += "reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::CalculationType & calc) {
    ...
    if( line.find("Numerical", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized calculation type while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::EquationSetting & eq_set) {
    ...
    if( line.find("None", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized equation setting while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::None & none) {
    ...
    std::getline(is,line);
    if( line.find("None", 0) == std::string::npos ) {
      std::string error_msg = "Unrecognized none setting while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::GradSetting & grad_set) {
    ...
    if( line.find("WRTDescriptor", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized gradiant setting while reading istream.\n";
  ...
  std::istream& operator>>(std::istream& is,  settings::KernelAlgorithm & kern_alg) {
    std::string line;
    std::getline(is,line);
    if( line.find("Strict", 0) != std::string::npos ) {
      ...
      std::string error_msg = "Unrecognized kernel algorithm setting while reading istream.\n";
